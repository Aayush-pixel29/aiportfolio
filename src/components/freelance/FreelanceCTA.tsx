  ...
  return (
    <section className="py-24 px-6 md:px-12 w-full max-w-7xl mx-auto">
      <motion.div 
        ...
        className="bg-electric rounded-[3rem] p-10 md:p-20 text-white relative overflow-hidden"
      >
        {/* Background decorative elements */}
        <div className="absolute -right-20 -top-40 w-96 h-96 bg-white/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -left-20 -bottom-20 w-80 h-80 bg-cyan/20 rounded-full blur-3xl pointer-events-none" />

        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <span className="font-mono text-sm font-medium text-white/60 tracking-widest uppercase block mb-8">
              06 — Currently Open
            </span>
            ...
            <Button 
              ...
              className="bg-white text-electric hover:bg-white/90 text-lg px-8 py-4"
            >
