...
export const PROFILE = {
  ...
  metrics: [
    ...
    { label: 'Engineered Systems', value: '11', subtext: '5 Featured Flagships + 6 Specialized Domain Systems' },
  ...
  journey: [
    ...
    },
    {
      ...
      evidence: ['Recon AI', 'Doc-Gen API', 'Passion Protocol', 'SEDEMAC ECU'],
    },
    {
      period: '2026',
      title: 'Agentic AI, IR & Control Plane Systems',
      description:
        'Autonomous systems: Multi-agent triage swarms, deterministic agent control planes (SENTINEL-X), hybrid ranking platforms (SearchOps), and local VLMs.',
      tags: ['Agent Control Planes', 'Hybrid IR', 'Multi-Agent Swarms', 'Local VLMs'],
      evidence: ['SRE Triage Swarm', 'SENTINEL-X', 'SearchOps', 'SkillFoundry', 'IndicDoc-VQA'],
    },
  ],
  ...
  skillMap: [
    {
      ...
      verificationBadge: '5 Core Systems · RAG · Swarms · IR',
      skills: [
        'Python',
        'LangChain',
        'Gemini API',
      ...
      evidence: ['SRE Triage Swarm', 'SENTINEL-X', 'SearchOps', 'SkillFoundry', 'Interview Agent'],
    },
    {
    ...
    },
    {
      ...
      verificationBadge: '6 Deployed Architectures',
      skills: [
        'FastAPI',
        'Next.js 14/15',
        'React',
      ...
      evidence: ['SearchOps', 'Doc-Gen API', 'Recon AI', 'Passion Protocol', 'SENTINEL-X'],
    },
    {
      title: 'Cloud, DevTools & Security',
      verificationBadge: 'CI/CD · Agent Gates · AST Rules',
      skills: [
        'Docker',
        'Git & GitHub Actions',
        'ToolShield Policy Engine',
        'MCP Gateway',
        'Semgrep AST Rules',
        'Gitleaks',
      ...
      evidence: ['SENTINEL-X Control Plane', 'SEDEMAC Mechatronics', 'Recon AI PWA'],
    },
  ],
