...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenContact }) => {
  return (
    ...
    >
      {/* 4 Decorative 3D Images in Corners (Clean: Hidden on Mobile < md to keep viewport distraction-free) */}

      {/* Top-left: Moon icon */}
      <div className="absolute top-[2%] left-[1%] sm:left-[2%] md:left-[4%] z-0 pointer-events-none opacity-80 hidden md:block">
        <FadeIn delay={0.1} duration={0.9} x={-80} y={0}>
          <img
            src="https://shrug-person-78902957.figma.site/_components/v2/ebb2b8f25d8e24d5f0a5ca8af4c950de81aa2fd7/moon_icon.11395d36.png"
            alt="3D Moon element"
            className="w-[120px] md:w-[180px] h-auto object-contain drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]"
      ...
      <div className="absolute bottom-[4%] left-[2%] sm:left-[5%] md:left-[8%] z-0 pointer-events-none opacity-80 hidden md:block">
        <FadeIn delay={0.25} duration={0.9} x={-80} y={0}>
          <img
            src="https://shrug-person-78902957.figma.site/_components/v2/ebb2b8f25d8e24d5f0a5ca8af4c950de81aa2fd7/p59_1.4659672e.png"
            alt="3D object element"
            className="w-[100px] md:w-[150px] h-auto object-contain drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]"
            referrerPolicy="no-referrer"
            loading="lazy"
          />
        </FadeIn>
      ...
      {/* Top-right: Lego icon */}
      <div className="absolute top-[2%] right-[1%] sm:right-[2%] md:right-[4%] z-0 pointer-events-none opacity-80 hidden md:block">
      ...
      <div className="absolute bottom-[4%] right-[2%] sm:right-[5%] md:right-[8%] z-0 pointer-events-none opacity-80 hidden md:block">
        <FadeIn delay={0.3} duration={0.9} x={80} y={0}>
          <img
            src="https://shrug-person-78902957.figma.site/_components/v2/ebb2b8f25d8e24d5f0a5ca8af4c950de81aa2fd7/Group_134-1.2e04f3ce.png"
            alt="3D group element"
            className="w-[130px] md:w-[190px] h-auto object-contain drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]"
            referrerPolicy="no-referrer"
            loading="lazy"
          />
        </FadeIn>
      ...
      <div className="relative z-10 max-w-5xl w-full flex flex-col items-center text-center">
        {/* Sub-label */}
        <FadeIn delay={0} y={20}>
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/10 bg-white/5 mb-4 sm:mb-6 text-[11px] sm:text-xs uppercase tracking-widest text-[#BBCCD7] font-semibold">
        ...
        <FadeIn delay={0.05} y={40}>
          <h2
            style={{ fontSize: 'clamp(2.6rem, 10vw, 150px)' }}
        ...
        <AnimatedText
          ...
          className="text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[680px] mx-auto text-[clamp(0.95rem,2vw,1.35rem)] px-1"
        />
        ...
        <FadeIn delay={0.1} y={20}>
          <div className="mt-6 sm:mt-8 flex items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white text-xs uppercase tracking-widest font-semibold transition-all active:scale-95 shadow-lg"
            >
        ...
        {/* Proof Signals Grid */}
        <div className="w-full mt-12 sm:mt-16 pt-10 border-t border-white/10">
          <div className="text-[11px] sm:text-xs uppercase tracking-widest text-[#BBCCD7] font-semibold text-center mb-6 sm:mb-8 flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 text-left">
            {PROFILE.metrics.map((item, index) => (
              <FadeIn key={index} delay={index * 0.1} y={20}>
                <div className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-white/[0.03] border border-white/10 hover:border-white/20 transition-colors">
                  <div className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight mb-1 font-mono">
                    {item.value}
                  </div>
                  <div className="text-[11px] xs:text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#BBCCD7]">
                    {item.label}
                  </div>
                  <div className="text-[10px] xs:text-xs text-[#D7E2EA]/60 font-light mt-1 leading-snug">
                    {item.subtext}
                  </div>
                </div>
              </FadeIn>
        ...
        <div className="w-full mt-8 sm:mt-12 text-left">
          <FadeIn delay={0.15} y={20}>
            <div className="p-5 sm:p-8 rounded-[24px] sm:rounded-[32px] bg-white/[0.03] border border-white/10 relative overflow-hidden">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 pb-4 border-b border-white/10 mb-4 sm:mb-5">
                <div className="flex items-center gap-3">
                  <div className="p-2 sm:p-2.5 rounded-2xl bg-[#7621B0]/20 border border-[#7621B0]/40 text-[#B600A8] shrink-0">
                    <GraduationCap className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="text-[10px] sm:text-xs uppercase tracking-widest text-[#BBCCD7] font-mono block">
                      Education &amp; Qualifications
                    </span>
                    <h3 className="text-base sm:text-xl font-bold uppercase tracking-tight text-white leading-snug">
                ...
                <div className="flex items-center gap-2.5 flex-wrap">
                  <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/15 border border-emerald-400/30 text-emerald-300 font-mono text-[11px] font-semibold">
              ...
              <div className="text-xs sm:text-sm text-[#D7E2EA]/85 font-light mb-3">
              ...
              <div className="space-y-2 pt-2 border-t border-white/5">
                {PROFILE.education.achievements.map((ach, aIdx) => (
                  <div key={aIdx} className="flex items-start gap-2 text-xs sm:text-sm text-[#D7E2EA]/80 font-light leading-relaxed">
        ...
        <div className="w-full mt-8 sm:mt-10 text-left">
          <FadeIn delay={0.2} y={20}>
            <div className="p-5 sm:p-8 rounded-[24px] sm:rounded-[32px] bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/15">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-white/10 mb-5 gap-2">
                <div>
                  <span className="text-[10px] sm:text-xs uppercase tracking-widest text-[#BBCCD7] font-mono block mb-1">
                    Production Stack
                  </span>
                ...
                <span className="text-[11px] xs:text-xs px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-400/30 text-emerald-300 font-mono self-start sm:self-auto">
                  Verified Deployments
                </span>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div className="p-3.5 sm:p-4 rounded-2xl bg-white/[0.02] border border-white/10 space-y-1.5">
