        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-6 border-b border-white/10">
              <div>
                <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#BBCCD7] font-semibold mb-2">
              ...
              <div className="flex items-center gap-3 shrink-0 flex-wrap">
                {project.githubUrl && (
                  <a
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/20 text-white text-xs uppercase tracking-widest hover:bg-white/10 transition-colors"
                  >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-white/10">
              ...
              <div className="space-y-4 bg-white/5 rounded-3xl p-5 border border-white/10">
                ...
                <div>
                  <div className="text-xs uppercase tracking-wider text-[#D7E2EA]/50 font-light">Technologies</div>
